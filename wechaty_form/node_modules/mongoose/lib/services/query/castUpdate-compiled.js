...
module.exports = function castUpdate(schema, obj, options) {
  ...
  while (i--) {
    ...
    if (val && typeof val === 'object' && (!overwrite || hasDollarKey)) {
  ...
  while (i--) {
    ...
    if (val && val.constructor.name === 'Object') {
      ...
      if (schematype && schematype.caster && op in castOps) {
        ...
        hasKeys |= walkUpdatePath(schema, val, op, strict, prefix + key) || utils.isObject(val) && Object.keys(val).length === 0;
      }
    } else {
...
//# sourceMappingURL=castUpdate-compiled.js.map