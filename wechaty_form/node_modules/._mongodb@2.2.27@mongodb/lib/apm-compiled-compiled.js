...
var Instrumentation = function (core, options, callback) {
  ...
  prototypes = [require('./cursor').prototype, require('./command_cursor').prototype, require('./aggregation_cursor').prototype];
...
//# sourceMappingURL=apm-compiled-compiled.js.map