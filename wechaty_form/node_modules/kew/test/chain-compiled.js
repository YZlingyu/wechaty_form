...
exports.testSynchronousThenAndFin = function (test) {
  ...
  Q.all([promise2, promise4]).then(function (data) {
...
exports.testSynchronousFailAndFin = function (test) {
  ...
  Q.all([promise2.fail(function (e) {
    return e === errs[0];
...
exports.testChainedFails = function (test) {
  ...
  Q.all([promise1.fail(function (e) {
    return e === errs[0];
...
exports.testChainedPromises = function (test) {
  ...
  Q.resolve("start").then(function () {
    return shouldFail;
  }).fail(function (e) {
    if (e === err) return shouldSucceed;else throw e;
  }).then(function (data) {
...
exports.testAllSettled = function (test) {
  ...
  Q.allSettled([promise1, promise2, 'just a string']).then(function (data) {
  ...
  Q.allSettled([]).then(function (data) {
