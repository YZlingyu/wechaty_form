...
exports.testGeneralContextFlow = function (test) {
	...
	.setContext({ counter: 1 }).then(function (val, context) {
	...
	// return a context
	.then(function (val, context) {
		return Q.resolve(false).setContext({ counter: 0 });
	}).then(function (val, context) {
