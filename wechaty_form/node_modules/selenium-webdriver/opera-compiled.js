 ...
 * @const
 */
const OPERADRIVER_EXE = process.platform === 'win32' ? 'operadriver.exe' : 'operadriver';
...
class Driver extends webdriver.WebDriver {
  ...
  static createSession(opt_config, opt_service, opt_flow) {
    ...
    var caps = opt_config instanceof Options ? opt_config.toCapabilities() : opt_config || capabilities.Capabilities.opera();
...
//# sourceMappingURL=opera-compiled.js.map