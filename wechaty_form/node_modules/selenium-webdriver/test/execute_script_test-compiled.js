...
test.suite(function (env) {
  ...
  describe('executeScript;', function () {
    ...
    test.it('fails if script throws', function () {
      return execute('throw new Error("boom")').then(function () {
    ...
    test.it('fails if script does not parse', function () {
      return execute('throw function\\*').then(function () {
        throw shouldHaveFailed;
      }).catch(function (e) {
    ...
    describe('return values;', function () {
      ...
      test.ignore(env.browsers(Browser.IE)).it('can return empty object literal', function () {
      ...
      test.it('can return dom elements as web elements', function* () {
        let result = yield execute('return document.querySelector(".header.host")');
      ...
      test.it('can return array of dom elements', function* () {
        let result = yield execute('var nodes = document.querySelectorAll(".request,.host");' + 'return [nodes[0], nodes[1]];');
      ...
      test.it('can return a NodeList as an array of web elements', function* () {
        let result = yield execute('return document.querySelectorAll(".request,.host");');
    ...
    describe('parameters;', function () {
      ...
      test.ignore(env.browsers(Browser.FIREFOX, Browser.SAFARI)).it('can return arguments object as array', function* () {
      ...
      test.it('can pass object literal', function* () {
        let result = yield execute('return [typeof arguments[0], arguments[0].a]', { a: 'hello' });
      ...
      test.it('WebElement arguments are passed as DOM elements', function* () {
        ...
        let result = yield execute('return arguments[0].tagName.toLowerCase();', el);
      ...
      describe('using for..in loops;', function () {
        ...
        test.it('can iterate over input object keys', function () {
          return execute(function (thing) {
            ...
            return ret;
          }, { words: [{ word: 'fa' }, { word: 'fe' }, { word: 'fi' }] }).then(verifyJson(['fa', 'fe', 'fi']));
        });
    ...
    describe('async timeouts', function () {
      ...
      test.it('fails if script took too long', function () {
        return executeTimeOutScript(TOO_LONG_WAIT).then(function () {
...
//# sourceMappingURL=execute_script_test-compiled.js.map