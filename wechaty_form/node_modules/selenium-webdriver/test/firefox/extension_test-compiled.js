  ...
  it('can install a jetpack xpi file', function () {
    return io.tmpDir().then(function (dir) {
      return extension.install(JETPACK_EXTENSION, dir).then(function (id) {
        ...
        var copiedSha1 = crypto.createHash('sha1').update(fs.readFileSync(file)).digest('hex');

        var goldenSha1 = crypto.createHash('sha1').update(fs.readFileSync(JETPACK_EXTENSION)).digest('hex');
...
//# sourceMappingURL=extension_test-compiled.js.map