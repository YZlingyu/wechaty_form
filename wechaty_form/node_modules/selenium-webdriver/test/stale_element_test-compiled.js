...
test.suite(function (env) {
  ...
  test.ignore(env.browsers(Browser.SAFARI)).it('dynamically removing elements from the DOM trigger a ' + 'StaleElementReferenceError', function* () {
...
//# sourceMappingURL=stale_element_test-compiled.js.map