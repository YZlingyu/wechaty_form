...
test.suite(function (env) {
    ...
    test.ignore(env.browsers(Browser.FIREFOX, Browser.PHANTOM_JS, Browser.SAFARI)).describe('WebDriver.actions()', function () {
        ...
        test.it('can move to and click element in an iframe', function* () {
            ...
            yield driver.wait(until.elementLocated(By.id('ifr')), 5000).then(frame => driver.switchTo().frame(frame));

            let link = yield driver.findElement(By.id('link'));
            yield driver.actions().mouseMove(link).click().perform();
...
//# sourceMappingURL=actions_test-compiled.js.map