...
test.suite(function (env) {
  ...
  test.it('can connect to an existing session', function* () {
    ...
    return driver.getSession().then(session1 => {
      let driver2 = WebDriver.attachToSession(driver.getExecutor(), session1.getId());

      return assert(driver2.getTitle()).equalTo('Hello WebDriver').then(_ => {
...
//# sourceMappingURL=session_test-compiled.js.map