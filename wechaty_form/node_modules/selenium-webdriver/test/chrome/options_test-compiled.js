...
describe('chrome.Options', function () {
  describe('fromCapabilities', function () {
    ...
    it('should return a new Options instance if none were defined', function () {
      var options = chrome.Options.fromCapabilities(new webdriver.Capabilities());
    ...
    it('should rebuild options from incomplete wire representation', function () {
      var caps = webdriver.Capabilities.chrome().set('chromeOptions', {
        logPath: 'logFilePath'
      });
  ...
  describe('serialize', function () {
    it('base64 encodes extensions', function () {
      ...
      var wire = new chrome.Options().addExtensions(__filename)[symbols.serialize]();
...
test.suite(function (env) {
  ...
  describe('Chrome options', function () {
    test.it('can start Chrome with custom args', function* () {
      ...
      driver = yield env.builder().setChromeOptions(options).build();
...
//# sourceMappingURL=options_test-compiled.js.map