...
describe('safari.Options', function () {
  describe('fromCapabilities', function () {
    it('returns a new Options instance  if none were defined', function () {
      let options = safari.Options.fromCapabilities(new webdriver.Capabilities());
    ...
    it('extracts supported WebDriver capabilities', function () {
      let proxyPrefs = proxy.direct(),
          logPrefs = {},
          caps = webdriver.Capabilities.chrome().set(webdriver.Capability.PROXY, proxyPrefs).set(webdriver.Capability.LOGGING_PREFS, logPrefs);
  ...
  describe('toCapabilities', function () {
    ...
    before(function () {
      options = new safari.Options().setCleanSession(true);
    });
    ...
    it('sets generic driver capabilities', function () {
      ...
      options.setLoggingPrefs(loggingPrefs).setProxy(proxyPrefs);
...
//# sourceMappingURL=safari_test-compiled.js.map