...
describe('promise control flow', function () {
  enablePromiseManager(() => {
    ...
    beforeEach(function setUp() {
      ...
      uncaughtExceptions = [];
      flow.on(promise.ControlFlow.EventType.UNCAUGHT_EXCEPTION, onUncaughtException);
    });

    afterEach(function tearDown() {
      flow.removeAllListeners(promise.ControlFlow.EventType.UNCAUGHT_EXCEPTION);
      assert.deepEqual([], uncaughtExceptions, 'There were uncaught exceptions');
      flow.reset();
      promise.LONG_STACK_TRACES = false;
    });
    ...
    function waitForAbort(opt_flow) {
      ...
      return new NativePromise(function (fulfill, reject) {
        ...
        theFlow.once(promise.ControlFlow.EventType.UNCAUGHT_EXCEPTION, fulfill);
      });
    }
    ...
    function waitForIdle(opt_flow) {
      ...
      return new NativePromise(function (fulfill, reject) {
        ...
        theFlow.once(promise.ControlFlow.EventType.UNCAUGHT_EXCEPTION, reject);
      });
    }
    ...
    describe('testTryModelingFinally', function () {
      it('happyPath', function () {
         ...
         */
        schedulePush('foo').then(() => schedulePush('bar')).finally(() => schedulePush('baz'));
    ...
    describe('testWaiting', function () {
      ...
      it('aConditionThatReturnsATaskResult', function () {
        ...
        return waitForIdle().then(function () {
          assert.equal(3, count);
          assertFlowHistory('0: counting to 3', 'increment count', '1: counting to 3', 'increment count', '2: counting to 3', 'increment count', 'post wait');
        });
      });
      ...
      it('conditionContainsASubtask', function () {
        ...
        return waitForIdle().then(function () {
          assert.equal(3, count);
          assertFlowHistory('0: counting to 3', 'sub task', '1: counting to 3', 'sub task', '2: counting to 3', 'sub task', 'post wait');
        });
      });
      ...
      it('cancelsWaitIfScheduledTaskFails', function () {
        ...
        return waitForIdle().then(pair.assertErrback).then(function () {
          assertFlowHistory('0: waiting to go boom', 'boom', 'post wait');
        });
      });
      ...
      it('failsIfConditionHasAFailedSubtask', function () {
        ...
        return waitForIdle().then(function () {
          ...
          assertFlowHistory('0: waiting', 'maybe throw', '1: waiting', 'maybe throw', 'post wait');
        });
      });
      ...
      it('pollingLoopWaitsForAllScheduledTasksInCondition', function () {
        ...
        return waitForIdle().then(function () {
          ...
          assertFlowHistory('0: counting to 3', 'increment count', '1: counting to 3', 'increment count', '2: counting to 3', 'increment count', '3: counting to 3', 'increment count', 'post wait');
        });
      });
      ...
      it('scheduleWithIntermittentAndNestedWaits', function () {
        ...
        return waitForIdle().then(function () {
          assertFlowHistory('a', '0: wait 1', 'd', '0: wait 2', 'e', 'b', '0: wait 3', 'c', '0: wait 4');
        });
      });
      ...
      it('promiseThatDoesNotResolveBeforeTimeout', function () {
        ...
        flow.wait(d.promise, 5).then(fail, function (e) {
          assert.ok(e instanceof TimeoutError, 'Unexpected error: ' + e);
          assert.ok(/Timed out waiting for promise to resolve after \d+ms/.test(e.message), 'unexpected error message: ' + e.message);
        });
        return waitForIdle();
      });
    ...
    describe('testSubtasks', function () {
      ...
      it('nesting', function () {
        ...
        return waitForIdle().then(function () {
          assertFlowHistory('a', 'sub-tasks', 'b', 'sub-sub-tasks', 'c', 'd', 'e', 'f');
        });
      });
    ...
    describe('testEventLoopWaitsOnPendingPromiseRejections', function () {
      ...
      it('multipleRejections', function () {
        ...
        return new NativePromise(function (fulfill, reject) {
          ...
          flow.on(promise.ControlFlow.EventType.UNCAUGHT_EXCEPTION, fulfill);
        }).then(function (e) {
          assert.ok(e instanceof promise.MultipleUnhandledRejectionError, 'Not a MultipleUnhandledRejectionError');
    ...
    describe('testCancelsPromiseReturnedByCallbackIfFrameFails', function () {
      it('promiseCallback', function () {
        ...
        var deferredPair = callbackPair(null, function (e) {
          assert.equal('CancellationError: StubError', e.toString(), 'callback result should be cancelled');
        });
    ...
    it('testSynchronizeErrorsPropagateToOuterFlow', function () {
      ...
      return NativePromise.all([waitForIdle(innerFlow), waitForAbort(outerFlow).then(assertIsStubError)]);
    });
    ...
    it('testAbortsFramePromisedChainedFromTaskIsNotHandled', function () {
      promise.fulfilled().then(function () {
        promise.controlFlow().execute(function () {}).then(throwStubError);
      });
      return waitForAbort().then(assertIsStubError);
    });
    ...
    it('testMaintainsOrderWithPromiseChainsCreatedWithinAForeach_1', function () {
      ...
      flow.execute(function () {
        ...
        steps.forEach(function (step) {
          promise.fulfilled(step).then(function () {
      ...
      return waitForIdle().then(function () {
        assert.deepEqual(['a.1', 'a.2', 'b.1', 'b.2', 'c.1', 'c.2', 'd.1', 'd.2'], messages);
      });
    });
    ...
    it('testMaintainsOrderWithPromiseChainsCreatedWithinAForeach_3', function () {
      ...
      flow.execute(function () {
        ...
        steps.forEach(function (step) {
          promise.fulfilled(step).then(function () {}).then(function () {
            messages.push(step + '.1');
    ...
    describe('testCancellingAScheduledTask', function () {
      ...
      it('4', function () {
        var seen = [];
        var task = scheduleAction('a', () => seen.push(1)).then(() => seen.push(2)).then(() => seen.push(3)).then(() => seen.push(4)).then(() => seen.push(5));
        task.cancel(new StubError());
    ...
    describe('testSettledPromiseCallbacksInsideATask', function () {
      ...
      it('2', function () {
        ...
        flow.execute(function () {
          flow.execute(() => order.push('a')).then(() => order.push('c'));
          flow.execute(() => order.push('b'));
        }).then(() => order.push('fin'));
...
//# sourceMappingURL=promise_flow_test-compiled.js.map