  ...
  enablePromiseManager(() => {
    ...
    global.describe = function (name, fn) {
      realDescribe(name, function () {
        var prefix = 'Promises/A+ Compliance Tests ' + 'SELENIUM_PROMISE_MANAGER=true 2.2.6: ' + '`then` may be called multiple times on the same promise.';
        var suffix = 'even when one handler is added inside another handler';
        if (this.fullTitle().startsWith(prefix) && this.fullTitle().endsWith(suffix)) {
...
//# sourceMappingURL=promise_aplus_test-compiled.js.map