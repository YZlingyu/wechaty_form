...
describe('Capabilities', function () {
  ...
  it('can merge capabilities', function () {
    let caps1 = new Capabilities().set('foo', 'bar').set('color', 'red');

    let caps2 = new Capabilities().set('color', 'green');
  ...
  describe('serialize', function () {
    ...
    it('does not omit capabilities set to a false-like value', function () {
      ...
      assert.deepEqual({ bool: false, number: 0, string: '' }, caps[Symbols.serialize]());
    });
...
//# sourceMappingURL=capabilities_test-compiled.js.map