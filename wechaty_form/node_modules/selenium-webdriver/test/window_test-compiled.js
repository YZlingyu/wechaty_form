...
test.suite(function (env) {
  ...
  function changeSizeBy(dx, dy) {
    return driver.manage().window().getSize().then(function (size) {
      return driver.manage().window().setSize(size.width + dx, size.height + dy).then(_ => {
        return driver.wait(forSizeToBe(size.width + dx, size.height + dy), 1000);
      });
    });
  }
...
//# sourceMappingURL=window_test-compiled.js.map