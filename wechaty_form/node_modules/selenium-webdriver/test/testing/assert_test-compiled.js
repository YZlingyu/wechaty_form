...
describe('assert', function () {
  describe('atLeast', function () {
    ...
    it('accepts failure message', function () {
      assertThrows(() => assert(1).atLeast(2, 'hi there!'), error => error.message.indexOf('hi there') != -1);
    });
    ...
    it('waits for promised subject (with failure)', function () {
      return assert(Promise.resolve(100)).atLeast(123).then(() => fail('should have failed'), function (e) {
  ...
  describe('atMost', function () {
    ...
    it('accepts failure message', function () {
      assertThrows(() => assert(1).atMost(0, 'hi there!'), error => error.message.indexOf('hi there!') != -1);
    });
    ...
    it('waits for promised subject (with failure)', function () {
      return assert(Promise.resolve(123)).atMost(100).then(() => fail('should have failed'), function (e) {
        assertInstanceOf(AssertionError, e);
  ...
  describe('greaterThan', function () {
    ...
    it('accepts failure message', function () {
      assertThrows(() => assert(0).greaterThan(1, 'hi there!'), error => error.message.indexOf('hi there!') != -1);
    });
    ...
    it('waits for promised subject (with failure)', function () {
      return assert(Promise.resolve(100)).greaterThan(123).then(() => fail('should have failed'), function (e) {
        assertInstanceOf(AssertionError, e);
        assertEqual('100 > 123', e.message);
      });
    });
  ...
  describe('lessThan', function () {
    ...
    it('accepts failure message', function () {
      assertThrows(() => assert(1).lessThan(0, 'hi there!'), error => error.message.indexOf('hi there!') != -1);
    });
    ...
    it('waits for promised subject (with failure)', function () {
      return assert(Promise.resolve(123)).lessThan(100).then(() => fail('should have failed'), function (e) {
        assertInstanceOf(AssertionError, e);
        assertEqual('123 < 100', e.message);
      });
    });
  ...
  describe('matches', function () {
    ...
    it('requires a string value (promise case)', function () {
      return assert(Promise.resolve(1234)).matches(/abc/).then(fail, function (error) {
        assertEqual('Expected a string matching /abc/, got <1234> (number)', error.message);
      });
    });
  ...
  describe('isTrue', function () {
    ...
    it('rejects false values', function () {
      ...
      return assert(Promise.resolve(false)).isTrue().then(fail, function () {/*no-op, ok*/});
    });
  });
  ...
  describe('isFalse', function () {
    ...
    it('rejects true values', function () {
      ...
      return assert(Promise.resolve(true)).isFalse().then(fail, function () {/*no-op, ok*/});
    });
  });
...
//# sourceMappingURL=assert_test-compiled.js.map