...
test.suite(function (env) {
  describe('rect commands', function () {
    ...
    test.before(function* () {
      ...
      yield driver.get('data:text/html,<!DOCTYPE html><style>' + '*{padding:0; margin:0}' + 'div{position: absolute; top: 50px; left: 50px;' + 'height: 50px;width:50px;background: green;}' + '</style><div>Hello</div>');
...
//# sourceMappingURL=rect_test-compiled.js.map