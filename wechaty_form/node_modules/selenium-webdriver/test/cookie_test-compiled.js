...
test.suite(function (env) {
  ...
  test.ignore(env.browsers(Browser.PHANTOM_JS, Browser.SAFARI)).describe('Cookie Management;', function () {
    ...
    test.it('can delete all cookies', function* () {
      ...
      yield driver.executeScript('document.cookie = arguments[0] + "=" + arguments[1];' + 'document.cookie = arguments[2] + "=" + arguments[3];', cookie1.name, cookie1.value, cookie2.name, cookie2.value);
      yield assertHasCookies(cookie1, cookie2);
    ...
    test.it('should only delete cookie with exact name', function* () {
      ...
      yield driver.executeScript('document.cookie = arguments[0] + "=" + arguments[1];' + 'document.cookie = arguments[2] + "=" + arguments[3];' + 'document.cookie = arguments[4] + "=" + arguments[5];', cookie1.name, cookie1.value, cookie2.name, cookie2.value, cookie3.name, cookie3.value);
    ...
    test.it('can delete cookies set higher in the path', function* () {
      ...
      var grandchildUrl = fileserver.whereIs('child/grandchild/grandchildPage.html');
    ...
    test.ignore(env.browsers(Browser.ANDROID, Browser.FIREFOX, 'legacy-' + Browser.FIREFOX, Browser.IE)).it('should retain cookie expiry', function* () {
  ...
  function assertHasCookies(...expected) {
    return driver.manage().getCookies().then(function (cookies) {
      assert.equal(cookies.length, expected.length, 'Wrong # of cookies.' + '\n  Expected: ' + JSON.stringify(expected) + '\n  Was     : ' + JSON.stringify(cookies));
...
//# sourceMappingURL=cookie_test-compiled.js.map