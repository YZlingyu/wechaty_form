...
class Capabilities extends Map {
   ...
   */
  static android() {
    return new Capabilities().set(Capability.BROWSER_NAME, Browser.ANDROID).set(Capability.PLATFORM, 'ANDROID');
  }
   ...
   */
  static edge() {
    return new Capabilities().set(Capability.BROWSER_NAME, Browser.EDGE).set(Capability.PLATFORM, 'WINDOWS');
  }
...
//# sourceMappingURL=capabilities-compiled.js.map