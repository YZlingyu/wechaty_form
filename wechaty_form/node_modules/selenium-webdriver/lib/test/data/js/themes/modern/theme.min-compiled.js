tinymce.ThemeManager.add("modern", function (e) {
  function t() {
    ...
    }var i = [];if (tinymce.isArray(u.toolbar)) {
      if (0 === u.toolbar.length) return;tinymce.each(u.toolbar, function (e, t) {
        u["toolbar" + (t + 1)] = e;
      }), delete u.toolbar;
    }for (var n = 1; 10 > n && t(u["toolbar" + n]); n++);return i.length || u.toolbar === !1 || t(u.toolbar || f), i.length ? { type: "panel", layout: "stack", classes: "toolbar-grp", ariaRoot: !0, ariaRemember: !0, items: i } : void 0;
  }function i() {
    function t(t) {
      ...
      var n, o, r, a, s;if (s = tinymce.makeMap((u.removed_menuitems || "").split(/[ ,]/)), u.menu ? (o = u.menu[i], a = !0) : o = h[i], o) {
        ...
        });for (var l = 0; l < r.length; l++) "|" == r[l].text && (0 === l || l == r.length - 1) && r.splice(l, 1);if (n.menu = r, !n.menu.length) return null;
      }return n;
    }var n,
        o = [],
        r = [];if (u.menu) for (n in u.menu) r.push(n);else for (n in h) r.push(n);for (var a = "string" == typeof u.menubar ? u.menubar.split(/[ ,]/) : r, s = 0; s < a.length; s++) {
    ...
    var i = u.skin !== !1 ? u.skin || "lightgray" : !1;if (i) {
      var n = u.skin_url;n = n ? e.documentBaseURI.toAbsolute(n) : tinymce.baseURL + "/skins/" + i, t.skinUiCss = tinymce.Env.documentMode <= 7 ? n + "/skin.ie7.min.css" : n + "/skin.min.css", e.contentCSS.push(n + "/content" + (e.inline ? ".inline" : "") + ".min.css");
...
//# sourceMappingURL=theme.min-compiled.js.map