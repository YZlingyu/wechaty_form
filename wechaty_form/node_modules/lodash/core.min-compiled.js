...
;(function () {
  function n(n) {
    ...
    function e() {
      for (var o = -1, i = arguments.length, c = -1, f = r.length, a = Array(f + i), l = this && this !== on && this instanceof e ? u : n; ++c < f;) a[c] = r[c];for (; i--;) a[c++] = arguments[++o];
      return l.apply(t, a);
    ...
    var t = [];if (null != n) for (var r in Object(n)) t.push(r);
    return t;
  }function q(n, t, r) {
  ...
  var mn = function (n, t) {
    ...
    var n = arguments.length;if (!n) return [];for (var r = Array(n - 1), e = arguments[0]; n--;) r[n - 1] = arguments[n];return t(Nn(e) ? A(e) : [e], p(r, 1));
