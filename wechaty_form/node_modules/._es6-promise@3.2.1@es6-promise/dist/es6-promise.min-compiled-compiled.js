...
(function () {
  ...
  function t(t) {
    ...
    tt[J] = t, tt[J + 1] = e, J += 2, 2 === J && (G ? G(a) : H());
      ...
      lt = q,
      ht = F,
      pt = L;L.all = ft, L.race = lt, L.resolve = nt, L.reject = ht, L._setScheduler = n, L._setAsap = r, L._asap = Q, L.prototype = { constructor: L, then: et, "catch": function (t) {
...
//# sourceMappingURL=es6-promise.min-compiled-compiled.js.map