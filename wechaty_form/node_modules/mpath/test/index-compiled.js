    ...
    describe('with `special`', function () {
      ...
      describe('that is a function', function () {
        ...
        it('works', function (done) {
          ...
          assert.deepEqual([{}, { comments: [{ val: 'twoo' }] }], mpath.get('comments.2.comments', o, special));

          assert.deepEqual({ comments: [{ val: 'twoo' }] }, mpath.get('comments.2.comments.1', o, special));
