    ...
    getChromeDriver() {
        return __awaiter(this, void 0, void 0, function* () {
           ...
           */
            ...
            let driver;
            while (ttl--) {
                config_1.log.verbose('PuppetWebBrowserDriver', 'initChromeDriver() ttl: %d', ttl);
                try {
                    ...
                    config_1.log.warn('PuppetWebBrowserDriver', 'initChromeDriver() ttl:%d exception: %s, ttl: %d', ttl, e.message);
                    driverError = e;
                }
            }
            config_1.log.warn('PuppetWebBrowserDriver', 'initChromeDriver() not valid with ttl expired: %s', driverError.stack);
            throw driverError;
        });
    }
    getPhantomJsDriver() {
